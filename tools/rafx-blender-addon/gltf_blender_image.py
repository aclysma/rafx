...
class ExportImage:
    ...
    def __on_happy_path(self) -> bool:
        ...
        #         print("dst_chan:", dst_chan, "src_chan:", fill.src_chan, "image:", fill.image.name)
        #     else:
        #         print("dst_chan:", dst_chan, "src_chan: Fill White")
    ...
    def encode(self, file_format: str) -> bytes:
        #self.file_format = {
        #    "image/jpeg": "JPEG",
        #    "image/png": "PNG"
        #}.get(mime_type, "PNG")
    ...
    def __encode_unhappy(self) -> bytes:
        ...
        print("Generating {}x{} PBR texture".format(width, height))
