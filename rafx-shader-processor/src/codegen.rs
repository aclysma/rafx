...
use rafx_resources::vk_description::DescriptorType;
...
fn rust_header(rust_code: &mut Vec<String>) {
    ...
    rust_code.push("use rafx_resources::ash::prelude::VkResult;\n\n".to_string());
    rust_code.push("#[allow(unused_imports)]\n".to_string());
    rust_code.push("use rafx_resources::{ResourceArc, ImageViewResource, DynDescriptorSet, DescriptorSetAllocator, DescriptorSetInitializer, DescriptorSetArc};\n\n".to_string());
}
