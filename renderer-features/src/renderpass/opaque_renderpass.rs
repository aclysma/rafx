...
use renderer_assets::resource_managers::{PipelineSwapchainInfo, MeshInfo, DynDescriptorSet, ResourceManager};
use renderer_assets::pipeline::gltf::{MeshVertex, MeshAsset};
