// use hydrate_base::handle::{AssetHandle, RefOp, TypedAssetStorage};
// use hydrate_base::{handle::LoaderInfoProvider, AssetTypeId, LoadHandle};
// use hydrate_loader::storage::{AssetLoadOp, AssetStorage, IndirectionTable};
//
...
// }
//
// // Implement hydrate's AssetStorage - an untyped trait that finds the asset_type's storage and
// // forwards the call
...
// }
//
// // Implement hydrate's TypedAssetStorage - a typed trait that finds the asset_type's storage and
// // forwards the call
...
pub use hydrate_loader::asset_storage::*;
