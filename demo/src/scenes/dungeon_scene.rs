    ...
    pub(super) fn new(
        ...
        *render_options = RenderOptions::default_3d();
        ...
        let camera_path_data_str = include_str!(concat!(
            ...
            "/assets/private/synty_simple_dungeon/camera_path.json"
        ));
        ...
        let prefab = SpawnablePrefab::blocking_load_from_symbol_name(
            resources,
            "assets://demo/synty_simple_dungeon/scene/imported_scene.blender_prefab",
        );
...
impl super::TestScene for DungeonScene {
    fn update(
        &mut self,
        _world: &mut World,
