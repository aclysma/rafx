...
pub type EguiRenderObjectStaticData = ();
...
pub type EguiViewPacket = ViewPacket<EguiRenderFeatureTypes>;
...
pub type EguiViewSubmitPacket = ViewSubmitPacket<EguiRenderFeatureTypes>;
