...
pub type SpriteRenderObjectStaticData = SpriteRenderObject;
...
pub type SpriteViewPacket = ViewPacket<SpriteRenderFeatureTypes>;
...
pub type SpriteViewSubmitPacket = ViewSubmitPacket<SpriteRenderFeatureTypes>;
