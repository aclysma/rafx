...
pub type ImGuiRenderObjectStaticData = ();
...
pub type ImGuiViewPacket = ViewPacket<ImGuiRenderFeatureTypes>;
...
pub type ImGuiViewSubmitPacket = ViewSubmitPacket<ImGuiRenderFeatureTypes>;
