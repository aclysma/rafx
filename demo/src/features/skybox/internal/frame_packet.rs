...
pub type SkyboxRenderObjectStaticData = ();
...
pub type SkyboxViewPacket = ViewPacket<SkyboxRenderFeatureTypes>;
...
pub type SkyboxViewSubmitPacket = ViewSubmitPacket<SkyboxRenderFeatureTypes>;
