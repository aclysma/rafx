...
pub const OUT_TEX_DESCRIPTOR_SET_INDEX: usize = 0;
pub const OUT_TEX_DESCRIPTOR_BINDING_INDEX: usize = 2;

pub struct DescriptorSet0Args<'a> {
    pub tex: &'a ResourceArc<ImageViewResource>,
    pub out_tex: &'a ResourceArc<ImageViewResource>,
}
...
impl<'a> DescriptorSetWriter<'a> for DescriptorSet0Args<'a> {
    fn write_to(
        ...
        descriptor_set.set_image(OUT_TEX_DESCRIPTOR_BINDING_INDEX as u32, args.out_tex);
    }
}
...
impl DescriptorSet0 {
    ...
    pub fn set_out_tex(
        &mut self,
        out_tex: &ResourceArc<ImageViewResource>,
    ) {
        self.0
            .set_image(OUT_TEX_DESCRIPTOR_BINDING_INDEX as u32, out_tex);
    }
