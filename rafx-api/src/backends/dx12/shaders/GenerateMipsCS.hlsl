...
cbuffer CB0 : register(b0)
{
    ...
    uint Packed_IsSrgb_NumMipLevels;
...
{
    bool is_srgb = ((Packed_IsSrgb_NumMipLevels & 0xFFFF0000) != 0);
    uint NumMipLevels = Packed_IsSrgb_NumMipLevels & 0x0000FFFF;
    ...
    OutMip1[DTid.xy] = PackColor(Src1, is_srgb);
    ...
    if ((GI & 0x9) == 0)
    {
        ...
        OutMip2[DTid.xy / 2] = PackColor(Src1, is_srgb);
        StoreColor(GI, Src1);
    }
    ...
    if ((GI & 0x1B) == 0)
    {
        ...
        OutMip3[DTid.xy / 4] = PackColor(Src1, is_srgb);
        StoreColor(GI, Src1);
    }
    ...
    if (GI == 0)
    {
        ...
        OutMip4[DTid.xy / 8] = PackColor(Src1, is_srgb);
    }
}
