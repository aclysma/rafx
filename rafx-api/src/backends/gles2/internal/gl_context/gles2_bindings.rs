// Autogenerated GL ES 2.0 bindings, with extension GL_OES_vertex_array_object. Hand-edited to
// also accept those function names without OES on the end of them. This ensures these functions
// are available when running on desktop GL
