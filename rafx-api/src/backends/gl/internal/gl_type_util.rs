...
pub fn byte_size_of_type(gl_type: GLenum) -> u32 {
    match gl_type {
        gles20::INT | gles20::BOOL | gles20::FLOAT => 4,
        gles20::INT_VEC2 | gles20::BOOL_VEC2 | gles20::FLOAT_VEC2 => 8,
        gles20::INT_VEC3
        | gles20::BOOL_VEC3
        | gles20::FLOAT_VEC3
        | gles20::INT_VEC4
...
pub fn set_uniform<T: Copy>(
    ...
    match gl_type {
        gles20::INT | gles20::BOOL | gles20::SAMPLER_2D | gles20::SAMPLER_CUBE => {
            gl_context.gl_uniform_1iv(location, data, count)
        }
        gles20::FLOAT => gl_context.gl_uniform_1fv(location, data, count),
        gles20::INT_VEC2 | gles20::BOOL_VEC2 => gl_context.gl_uniform_2iv(location, data, count),
        gles20::FLOAT_VEC2 => gl_context.gl_uniform_2fv(location, data, count),
        gles20::INT_VEC3 | gles20::BOOL_VEC3 => gl_context.gl_uniform_3iv(location, data, count),
        gles20::FLOAT_VEC3 => gl_context.gl_uniform_3fv(location, data, count),
        gles20::INT_VEC4 | gles20::BOOL_VEC4 => gl_context.gl_uniform_4iv(location, data, count),
