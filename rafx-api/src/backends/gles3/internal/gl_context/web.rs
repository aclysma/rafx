use crate::gles3::gles3_bindings::types::*;
use crate::gles3::{
    gles3_bindings, ActiveUniformInfo, BufferId, FramebufferId, ProgramId, RenderbufferId,
...
impl GlContext {
    ...
    pub fn gl_get_programiv(
        ...
        if pname == gles3_bindings::ACTIVE_UNIFORM_MAX_LENGTH {
            // Return a
            return Ok(256);
        }
    ...
    pub fn gl_active_texture(
        ...
        self.context.active_texture(gles3_bindings::TEXTURE0 + i);
        self.check_for_error()
    }
