...
impl RafxCommandPool {
    pub fn device_context(&self) -> RafxDeviceContext {
        match self {
            ...
            #[cfg(feature = "rafx-gl")]
            RafxCommandPool::Gl(inner) => RafxDeviceContext::Gl(inner.device_context().clone()),
            #[cfg(any(
                feature = "rafx-empty",
                not(any(feature = "rafx-metal", feature = "rafx-vulkan"))
            ))]
    ...
    pub fn create_command_buffer(
        ...
        Ok(match self {
            ...
            #[cfg(feature = "rafx-gl")]
            RafxCommandPool::Gl(inner) => {
                RafxCommandBuffer::Gl(inner.create_command_buffer(command_buffer_def)?)
            }
            #[cfg(any(
                feature = "rafx-empty",
                not(any(feature = "rafx-metal", feature = "rafx-vulkan"))
    ...
    pub fn reset_command_pool(&mut self) -> RafxResult<()> {
        match self {
            ...
            #[cfg(feature = "rafx-gl")]
            RafxCommandPool::Gl(inner) => inner.reset_command_pool(),
            #[cfg(any(
                feature = "rafx-empty",
                not(any(feature = "rafx-metal", feature = "rafx-vulkan"))
            ))]
    ...
    pub fn gl_command_pool(&self) -> Option<&RafxCommandPoolGl> {
        match self {
            ...
            RafxCommandPool::Metal(_) => None,
            #[cfg(feature = "rafx-gl")]
            RafxCommandPool::Gl(inner) => Some(inner),
            #[cfg(any(
                feature = "rafx-empty",
                not(any(feature = "rafx-metal", feature = "rafx-vulkan"))
            ))]
