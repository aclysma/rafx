...
impl RafxDeviceContext {
    ...
    pub fn device_info(&self) -> &RafxDeviceInfo {
        match self {
            ...
            #[cfg(feature = "rafx-gles2")]
            RafxDeviceContext::Gl(inner) => inner.device_info(),
            #[cfg(any(
                feature = "rafx-empty",
                not(any(feature = "rafx-metal", feature = "rafx-vulkan"))
            ))]
    ...
    pub fn create_fence(&self) -> RafxResult<RafxFence> {
        Ok(match self {
            ...
            #[cfg(feature = "rafx-gles2")]
            RafxDeviceContext::Gl(inner) => RafxFence::Gl(inner.create_fence()?),
            #[cfg(any(
                feature = "rafx-empty",
                not(any(feature = "rafx-metal", feature = "rafx-vulkan"))
            ))]
    ...
    pub fn create_semaphore(&self) -> RafxResult<RafxSemaphore> {
        Ok(match self {
            ...
            #[cfg(feature = "rafx-gles2")]
            RafxDeviceContext::Gl(inner) => RafxSemaphore::Gl(inner.create_semaphore()?),
            #[cfg(any(
                feature = "rafx-empty",
                not(any(feature = "rafx-metal", feature = "rafx-vulkan"))
            ))]
    ...
    pub fn create_texture(
        ...
        Ok(match self {
            ...
            #[cfg(feature = "rafx-gles2")]
            RafxDeviceContext::Gl(inner) => RafxTexture::Gl(inner.create_texture(texture_def)?),
            #[cfg(any(
                feature = "rafx-empty",
                not(any(feature = "rafx-metal", feature = "rafx-vulkan"))
            ))]
