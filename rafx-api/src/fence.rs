...
use crate::gles3::RafxFenceGles3;
...
impl RafxFence {
    ...
    pub fn get_fence_status(&self) -> RafxResult<RafxFenceStatus> {
        match self {
            ...
            #[cfg(feature = "rafx-gles3")]
            RafxFence::Gles3(inner) => inner.get_fence_status(),
            #[cfg(any(
                feature = "rafx-empty",
                not(any(
                    feature = "rafx-dx12",
    ...
    pub fn wait(&self) -> RafxResult<()> {
        match self {
            ...
            #[cfg(feature = "rafx-gles3")]
            RafxFence::Gles3(inner) => inner.wait(),
            #[cfg(any(
                feature = "rafx-empty",
                not(any(
                    feature = "rafx-dx12",
    ...
    pub fn gles3_fence(&self) -> Option<&RafxFenceGles3> {
        match self {
            ...
            RafxFence::Gles2(_) => None,
            #[cfg(feature = "rafx-gles3")]
            RafxFence::Gles3(inner) => Some(inner),
            #[cfg(any(
                feature = "rafx-empty",
                not(any(
                    feature = "rafx-dx12",
